...
const JobInfo = (props: {
  ...
  return (
    <div
      className={`border-4 p-4 rounded bg-white fixed w-[90vw] h-[90vh] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col gap-4 overflow-y-auto ${
        props.hidden ? "hidden" : ""
      }`}
    >
      ...
      <div className="flex gap-4 flex-wrap">
        ...
        <p className="text-slate-500 bg-slate-100 px-4 py-2 rounded">Onsite</p>
      </div>
      ...
      <div className="bg-slate-100 p-8 flex flex-col gap-4">
        ...
        <div className="flex gap-4 items-center">
          ...
          />
          <p className="uppercase font-bold text-slate-700">Laborum Company</p>
        </div>
        <p className="text-slate-500">
